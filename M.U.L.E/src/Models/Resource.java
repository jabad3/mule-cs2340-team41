...
/**
 * Resources for the game of MULE are items (excluding land plots) that can be
 * exchanged. The different types of Resources, then, are: Food, Energy, Ore,
 * Money, and Mule.
 * 
...
public enum Resource {
    FOOD(25), ENERGY(50), ORE(75), MONEY(0), MULE(0);
     ...
     * 
     * @param muleTypeScore
     *            The score bonus for mules that have been configured to this
     *            particular resource
     */
