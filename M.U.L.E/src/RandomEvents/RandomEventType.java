...
public enum RandomEventType {
    ALUMNI(
	    ...
	    "THE MUSEUM BOUGHT YOUR ANTIQUE PERSONAL COMPUTER FOR $ 8*m.",
	    false), RAT(
	    "YOU FOUND A DEAD MOOSE RAT AND SOLD THE HIDE FOR $2*m.", false), CATBUGS(
	    "FLYING CAT-BUGS ATE THE ROOF OFF YOUR HOUSE. REPAIRS COST $4*m.",
	    true), UGA(
	    "MISCHIEVOUS UGA STUDENTS BROKE INTO YOUR STORAGE SHED AND STOLE HALF YOUR FOOD.",
	    true), MESS(
    ...
    static RandomEventType[] allEvents = { ALUMNI, TRAVELER, MUSEUM, RAT,
	    CATBUGS, UGA, MESS };
     ...
     * @param isBad
     *            true is event is "bad", false if event is "good"
     */
