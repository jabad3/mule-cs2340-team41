...
/**
 * RatEvent is a subclass of RandomEvent that implements an action method that
 * performs this event's action
 * 
 * Event description: YOU FOUND A DEAD MOOSE RAT AND SOLD THE HIDE FOR $2*m.
 * 
 * @author kevin
 * 
 */
public class RatEvent extends RandomEvent {
	...
	int hidePrice = 2 * m;
	player.addResource(Resource.MONEY, hidePrice); // placeholder!, is
						       // really 2 * m-value!
