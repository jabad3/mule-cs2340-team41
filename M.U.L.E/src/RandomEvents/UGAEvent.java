...
/**
 * UGAEvent is a subclass of RandomEvent that implements an action method that
 * performs this event's action
 * 
 * Event description: MISCHIEVOUS UGA STUDENTS BROKE INTO YOUR STORAGE SHED AND
...
public class UGAEvent extends RandomEvent {
	...
	try {
	    player.removeResource(Resource.FOOD, curPlayerFood / 2); // get
								     // approx.
								     // half
								     // with
								     // integer
