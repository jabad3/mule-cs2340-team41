...
/**
 * The ProductionStage acts as the controller during the production phase of the
 * game.
 * 
 * During production, land plots produce resources that are added to their
 * owners' inventories. The view is then updated to indicate to the users how
 * their players' inventories have changed.
 * 
 * @author Max
 * 
 */
public class ProductionStage extends Stage {
     ...
     * 
     * @param mainFrame
     *            The frame to hold the Stage's view
     * @param gameModel
     *            The game model used during the game
     */
	...
	JOptionPane.showMessageDialog(
		mainFrame,
		"Production has taken place for Round #"
