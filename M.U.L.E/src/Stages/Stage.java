 ...
 * 
 * Stages are responsible for gathering relevant user input from their View and
 * changing the gameModel according to that input.
 * 
 ...
 * them. This allows for an event-driven game, as Stages are linked according to
 * the order specified by the rules of the game.
 * 
 * @author Tim Farley
 * @version 1
 */
public abstract class Stage {
    ...
    /**
     * The Stage that follows the current Stage according to the rules of the
     * game
     */
    Stage nextStage;
     ...
     * 
     * @param nextStage
     *            The Stage that should follow this Stage
     */
     ...
     * 
     * @param myView
     *            The View that belongs to this Stage
     */
    ...
    /**
     * Start this Stage. This Stage should create and setup a View to display in
     * the mainFrame.
     */
