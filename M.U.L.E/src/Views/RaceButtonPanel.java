...
public class RaceButtonPanel extends JPanel {
    ...
    /**
     * Constructor, sets layout and size of JPanel, adds actionlisteners to the
     * buttons and buttons to the JPanel
     */
    ...
    /**
     * Create buttons corresponding to all possible races in RaceType and add
     * them to the panel
     */
    ...
    /**
     * Private inner class defines what happens upon button click. Each race
     * button should have a separate instance of this class listening for an
     * ActionEvent.
     */
	 ...
	 * 
	 * @param race
	 *            The race that should be chosen when the button this
	 *            listner is assigned to is pressed
	 */
