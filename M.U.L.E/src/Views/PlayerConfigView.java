...
public class PlayerConfigView extends JPanel {
     ...
     * 
     * @param num
     *            Number between 1 and total number of players (inclusive)
    ...
    /**
     * Sets disabled colors in the View to manually prevent the same color from
     * being chosen twice.
     * 
     * @param disabledColors
     *            List of colors to disable in the view
     */
     ...
     *            ActionListener to respond to the next button being pressed
     */
