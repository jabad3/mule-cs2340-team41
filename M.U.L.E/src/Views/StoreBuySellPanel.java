...
public class StoreBuySellPanel extends JPanel {
     ...
     * 
     * @param storePanel
     *            The store panel to configure
     * @param buyListener
     *            Listener to call when buy selected
     * @param sellListener
     *            Listener to call when sell selected
     */
    public StoreBuySellPanel(StorePanel storePanel,
	    SelectionListener buyListener, SelectionListener sellListener) {
