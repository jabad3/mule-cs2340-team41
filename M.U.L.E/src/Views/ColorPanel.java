...
public class ColorPanel extends JPanel {
    ...
    /**
     * List of all buttons that will be displayed. A list must be kept so that
     * we can disable buttons that have been added to the panel.
     */
    ...
    /**
     * Contains a mapping of color names to Color objects for all colors that
     * the View will offer to the user.
     */
    private Map<String, Color> nameColorMap = new HashMap<>();

    /**
     * Creates the ColorPanel, adding ActionListeners to the buttons and buttons
     * to the JPanel
     */
    public ColorPanel() {
     ...
     * 
     * @param colors
     *            A list of color objects whose corresponding buttons need to be
     *            disabled
     */
     ...
     * Each color button should have a unique ColorButtonListener listening for
     * it to fire an ActionEvent.
     */
    private class ColorButtonListener implements ActionListener {
	/**
	 * The String representation of the color that is associated with the
	 * button that the ColorButtonListener will listen to
	 */
	String colorName;
	 ...
	 * 
	 * @param colorName
	 *            The String representation of the color that will be
	 *            selected when the ColorButtonListener responds to an
	 *            ActionEvent
	 */
