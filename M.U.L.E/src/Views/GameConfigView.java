...
/**
 * A GameConfigView must be able to display the following: 1) Difficulty choices
 * 2) Map type choices 3) Number of players choices 4) A way to let the User
 * confirm their choice (ex: Next button)
 * 
 * @author Max
 * 
 */
public abstract class GameConfigView extends JPanel {
     ...
     * 
     * @param difficulties
     *            Difficulty options to give the user
     */
     ...
     * 
     * @param mapChoices
     *            String array of map type options
     */
     ...
     * 
     * @param playerCountChoices
     *            int array of options for the number of players
     */
     ...
     *            ActionListener to listen for this finish event
     */
