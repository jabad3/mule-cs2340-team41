...
public class LandSelectionStage extends Stage {
     ...
     * 
     * @param mainFrame
     *            The container used to display the View
     * @param model
     *            The GameModel used throughout the game
     */
	...
	myView = new LandSelectionView(mapPanel, landPlotPrice,
		currentPlayerName, new SelectionSkipListener());
    ...
    /**
     * Assign plots to appropriate owners. Both the plot and the owner must be
     * aware of one another.
     * 
     * Pre-condition: plot must be available to be owned by another player
     * 
     * @param plot
     *            Unowned plot that will become owned
     * @param owner
     *            The new owner of the plot
     */
    ...
    /**
     * Chooses the next player in the land selection stage, then updates the
     * View to display this new change.
     * 
    ...
    /**
     * For demoing purposes to show the state of the model after land selection
     * is over
     */
    ...
    /**
     * Determines whether or not all players have had a turn during land
     * selection.
     * 
    ...
    /**
     * A user selects a LandPlot by clicking on it. This class listens for that
     * selection while providing user-friendly cues to indicate which plot the
     * user's mouse cursor is on.
     * 
     * @author Max
     * 
     */
	...
	public void mouseClicked(MouseEvent e) {
		...
		try {
		    currentPlayer
			    .paySeller(gameModel.getStore(), landPlotPrice);
	...
	public void mouseEntered(MouseEvent e) {
		...
		landPlotBtn.setBorder(BorderFactory.createLineBorder(
			tempBorderColor, 3));
	    }
	}
    ...
    /**
     * This class listens to the View for when the user triggers the event to
     * skip their turn during Land Selection.
     * 
     * @author Max
     * 
     */
