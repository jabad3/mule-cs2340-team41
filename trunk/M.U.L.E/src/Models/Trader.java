...
/**
 * A Trader represents an object in the game that has the ability to buy and
 * sell goods to others who are also Traders
 * 
 * @author Max
 * 
 */
public abstract class Trader implements Serializable {
    ...
    /**
     * This method is used to carry out a transaction between a buyer (this) and
     * a seller involving a resource.
     * 
     * Possible Buyer-Seller Pairs: Player-Player Player-Store Store-Player
     * 
     * @param seller
     *            Trader who is selling the resource
     * @param rType
     *            The type of resource that is being traded
     * @param unitPrice
     *            The price of a single unit of resource that is being traded
     * @throws FailedTransactionException
     *             Thrown when a buyer (this) does not have enough money, or
     *             when the seller does not have the resource in stock.
     */
    public void buyResourceFromSeller(Trader seller, Resource rType,
	    int unitPrice, int resourceCount) throws FailedTransactionException {
     ...
     * 
     * @param rType
     *            The type of Resource to remove
     * @throws FailedTransactionException
     *             Thrown when the Trader does not have any units of the
     *             resource, in which case it is impossible to remove a unit of
     *             the resource.
     */
    public void removeResource(Resource rType, int resourceCount)
	    throws FailedTransactionException {
     ...
     * 
     * @param seller
     *            The Trader who will receive the payment
     * @param price
     *            The amount that the seller will receive
     * @throws FailedTransactionException
     *             Thrown when the buyer (this) does not have enough money to
     *             make the payment.
     */
    public void paySeller(Trader seller, int price)
	    throws FailedTransactionException {
	// TODO
     ...
     * 
     * @param amount
     *            The total funds to add to the Trader's money balance
     */
     ...
     * 
     * @param seller
     *            The Trader selling the mule
     * @param muleConfig
     *            The ResourceType that the mule has been configured to produce
     * @param price
     *            The amount that the mule is being purchased for
     * @throws FailedTransactionException
     *             Thrown if the buyer does not have enough money to pay for the
     *             mule, or if the seller has no mules to sell
     */
}