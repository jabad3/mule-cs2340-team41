 ...
 * Similarly, RaceTypes also contain information regarding Player appearance, as
 * a Player's race is the primary factor for their on-screen appearance.
 * 
 * @author Max
 * 
 */
public enum RaceType {
    HUMAN(600, "humanoid.png"), FLAPPER(1600, "flapper.png"), BONZOID(1000,
	    "bonzoid.png"), UGAITE(1000, "ugaite.png"), BUZZITE(1000,
	    "buzzite.png");
     ...
     * 
     * @param startingMoney
     *            The starting money for this race
     * @param imageFilePath
     *            The path to the image file that will be used to generate an
     *            image icon for this race
     */
    ...
    /**
     * Get the stock (default) image icon associated with a particular RaceType.
     * 
    ...
    /**
     * Returns the RaceType name keeping only the first letter capitalized for
