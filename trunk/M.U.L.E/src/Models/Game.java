...
/**
 * This class orchestrates an entire game play session of MULE. All Stages and
 * the GameModel are instantiated in this class.
 * 
 * @author Tim Farley
 * @version 1
 */
...
public class Game {
    ...
    /**
     * Instantiates a new Game object to run a game of MULE using a previous
     * GameModel (ie. loading a game).
     * 
     * @param mainFrame
     *            An empty mainFrame
     */
    ...
    /**
     * Creates and links each stage to prepare the game loop. Begins a game of
     * MULE by starting the first stage of the game.
     */
    public void start() {
