 ...
 * 
 * All choices are displayed to the user using JComboBox, and the user presses a
 * "Next" button when they are finished with configuring the game.
 * 
 * @author Erica Pramer
 * @version 1
 */
public class BasicGameConfigView extends GameConfigView {
	...
	playerNumBox.setModel(new DefaultComboBoxModel<Integer>(
		playerCountChoices));
