...
/**
 * PlayerPawn represents a Player's on-screen image. PlayerPawn is shown during
 * Development and is able to be moved by the user using the arrow keys.
 * 
 * @author jabad3
 * 
 */
public class PlayerPawn extends ResizableIcon {
    ...
    /**
     * Create a PlayerPawn object to represent a Player using the Player's icon.
     * 
     * @param playerIcon
     *            The icon associated with a Player object
     */
    ...
    /**
     * Move the pawn left, right, up, and/or down depending on which keys are
     * currently pressed.
     */
    public void move() {
	int speed = 2;
     ...
     * 
     * @param listenToThis
     *            Component that accepts the KeyListener
     */
     ...
     * direction states.
     * 
     * This key listener should be added to a component that will stay in focus.
     * 
     * @author Max
     * 
     */
	 ...
	 * 
	 * @param e
	 *            The key event fired by the component being listened to
	 */
	...
	/**
	 * If any of the four arrow keys are released after being pressed, then
	 * reset the corresponding direction state of the pawn back to false.
	 * 
	 * @param e
	 *            The key event fired by the component being listened to
	 */
