 ...
 * This information includes: 1) Name 2) Money 3) Food 4) Energy 5) Ore
 * 
...
public class PlayerInfoPanel extends JPanel {
     ...
     * 
     * @param player
     *            The player to display information about
     */
    ...
    /**
     * Updates the panel to display the latest information about the current
     * player
     */
    public void refresh() {
	String name = player.getName();
     ...
     * 
     * @param player
     *            The new player to display information for
     */
