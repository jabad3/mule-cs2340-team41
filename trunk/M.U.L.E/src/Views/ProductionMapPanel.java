...
/**
 * This class is a MapPanel with the ability to display production results on
 * each plot icon. ProductionMapPanel also ignores repaint so that the displayed
 * production results do not get erased.
 * 
 * @author Max
 * 
 */
public class ProductionMapPanel extends MapPanel {
	...
	super(map);
	this.setIgnoreRepaint(true); // so what we draw does not get erased by
				     // automatic repaint
    }

    /**
     * Display the latest production results onto the panel. The resource type
     * and quantity will be displayed.
     */
     ...
     * 
     * @param index
     *            The plot component index in the map panel container
     */
