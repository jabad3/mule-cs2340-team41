...
/**
 * This class manages a player's interaction with the store through
 * buying/selling
 * 
 * @author Tim
 * 
...
public class StoreView extends JPanel {
    ...
    /**
     * A JPanel with card layout to allow easy swapping between transaction and
     * selection menus.
     */
     ...
     * 
     * @param storePanel
     *            The transaction panel to display to the user
     */
    public StoreView(StorePanel storePanel) {
	this.storePanel = storePanel;
	this.storeBuySellPanel = new StoreBuySellPanel(storePanel,
		new SelectionListener(true), new SelectionListener(false));
	 ...
	 * 
	 * @param isBuying
	 *            Whether to configure the store to buying or selling
	 */
	 ...
	 * 
	 * @param e
	 *            The action event fired to the listener
	 */
