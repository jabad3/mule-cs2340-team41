...
public class ResizableIcon extends JComponent {
    ...
    /**
     * Create a ResizableIcon to display the given ImageIcon object. Preferred
     * size of the component defaults to the icon's width and height.
     * 
     * @param icon
     *            The ImageIcon to be displayed
     */
     ...
     *            The ImageIcon to be displayed
     * @param preferredSize
     *            The Dimension of the preferred size
     */
    ...
    /**
     * Set the displayed icon and automatically updates the component to display
     * the new icon.
     * 
     * @param icon
     *            ImageIcon containing the icon to be displayed
     */
     ...
     * 
     * @param image
     *            Image object containing the icon to be displayed
     */
