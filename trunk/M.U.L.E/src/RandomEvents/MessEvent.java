...
/**
 * MessEvent is a subclass of RandomEvent that implements an action method that
 * performs this event's action
 * 
 * Event description: YOUR SPACE GYPSY INLAWS MADE A MESS OF THE TOWN. IT COST
 * YOU $6*m TO CLEAN IT UP.
 * 
 * @author kevin
 * 
 */
public class MessEvent extends RandomEvent {
	...
	int cleanupCost = 6 * m;
	try {
	    player.removeResource(Resource.MONEY, cleanupCost); // placeholder!
								// is really 6 *
								// m-value
