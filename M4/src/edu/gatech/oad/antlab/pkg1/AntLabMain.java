 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Timothy Farley");
		  toPrint += p1.toString("tfarley6");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Joseph Abad");
		  toPrint += p2.toString("jabad3");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Erica");
		  toPrint += p3.toString("epramer3");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Kevin");
          toPrint += p4.toString("kcipolla3");
